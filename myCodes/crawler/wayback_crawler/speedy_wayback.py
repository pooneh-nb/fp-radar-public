    ...
    while start_date <= end_date:
        ...
        try:
            ...
            if response.status_code == 400:
                #9555
                utilities.append_file('/home/pooneh/Desktop/OpenWPM/jsons/error/non_fp_err_logs.json',
...
def main():
    with open("/jsons/third_parties/non_fp_3rd_url_20k.json") as p:
    ...
    js_write_directory = "/home/pooneh/Desktop/OpenWPM/jsons/downloaded_files/non_fp_javascripts/new_version"
